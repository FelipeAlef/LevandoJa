...
uses
 EstabelecimentoWebApp, uFrmPrincipal;
...
begin
 D2BridgeServerController:= TEstabelecimentoWebAppGlobal.Create(nil);
 
 //App Information

 D2BridgeServerController.ServerAppTitle:= 'Meu Estabelecimento';
 D2BridgeServerController.ServerAppDescription:= 'Sistema Gestor';
 D2BridgeServerController.ServerAppAuthor:= 'LF Desenvolvimento de sistemas';


 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(80);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('Estabelecimento');

 D2BridgeServerController.APPName:= 'Meu Estabelecimento';
 D2BridgeServerController.APPDescription:= 'Sistema Gestor';
