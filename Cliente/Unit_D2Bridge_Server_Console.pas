...
begin
 D2BridgeServerController:= TClienteWebAppGlobal.Create(nil);
 
 //App Information

 D2BridgeServerController.ServerAppTitle:= 'LevandoJá';
 D2BridgeServerController.ServerAppDescription:= 'Sistema de delivery';
 D2BridgeServerController.ServerAppAuthor:= 'LF Desenvolvimento de tecnologias';

  
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(80);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('LevandoJá');

 D2BridgeServerController.APPName:= 'LevandoJá';
